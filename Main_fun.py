...
for archivo in range(len(onlyfiles)):
    ...
    start = time.time()  
    if forecast_method == "gp_ind_ori": 
        [YPredicted_24gp_ind_S,VPredicted_24gp_ind_S] = predGPind_ori(XTest_S,like,model)
    end_ind = time.time() 
    ...
    [_, YPredicted_24gp,VPredicted_24gp]=DeStandarizeData(YTest_24_S,YPredicted_24gp_ind_S,scalerY_24,VPredicted_24gp_ind_S,Standarize = Stand)
